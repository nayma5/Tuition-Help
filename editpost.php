...
<head>
	...
	<!-- date link end -->
	<!-- menu tab link -->
	<link rel="stylesheet" type="text/css" href="css/homemenu.css?v=<? php echo time(); ?>">
			  	...
			  	<div class="itemrow">
					...
					<div class="itemrow">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="None">None</option>
							  <option value="Southeast University">East West University</option>
					...
					<div class="itemrow">
				  			...
				  			<div style="width: 20%; float: left;">
				  				<p><?php echo '<input name="deadline" type="text" id="datepicker" placeholder="e.g: 30/04/2021" value="'.$deadline.'">'; ?></p>
				  			</div>
				  	</div>
